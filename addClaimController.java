...
public class addClaimController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Fetch and set claims for each user product
        for (userProduct product : userProducts) {
            int userProductId = claimService.getUserProductId(username, product.getProductSerialNo()); 
    	    
          List<Claim> claims = claimService.getClaimsForUserProduct(userProductId);
